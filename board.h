...
#define MAX_BOARD 81//plateau contenant la place pour les murs et les case pour se deplacer 169 289
#define WH_BOARD 9//largeur du plateau avec les murs toujours impair car on peut pas placer 5 13 17
